...
const Footer = () => {
    return (
        ...
        <footer class="mt-[20%] text-center lg:text-left bg-gray-100 text-gray-600">
          ...
          ">
                            ...
                            <span className='ml-2'>NISSAN PARTS</span>
                        </h6>
                        <p>
            ...
            <div class="text-center p-6 bg-gray-200">
                ...
                <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/"> NISSAN PARTS</a>
            </div>
        </footer>
    );
};
