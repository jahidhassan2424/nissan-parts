                        ...
                        <form onSubmit={handleLogin}>
                            <div class="card-body">
                                ...
                                <div class="form-control mb-5">
                                    ...
                                    <input type="text" placeholder="Email" name='email' class="input input-bordered text-xl" required />
                                </div>
                                <div class="form-control">
                                    <label class="label">
                                        <span class="label-text text-xl">Password</span>
                                    </label>
                                    <input type="text" placeholder="Password" name='password' class="input input-bordered text-xl" required />
